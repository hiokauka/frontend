...
import { mainListItems } from './adminlist';
import { useNavigate } from 'react-router-dom';
import Admincurrency from './editcurrency';
      ...
      <Box sx={{ display: 'flex' }}>
        ...
        <Box
          ...
          sx={{
            ...
            position: 'relative',
            backgroundImage: 'url(/gringgotsbank2_1.jpg)', // Replace with your image path
